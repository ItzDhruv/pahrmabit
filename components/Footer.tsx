...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#91d567] text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-white text-sm">Trusted Blockchain for Pharma and Crypto</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#home" className="text-white hover:text-[#447EF2] transition-colors cursor-pointer">Home</Link></li>
              <li><Link href="#about" className="text-white hover:text-[#447EF2] transition-colors cursor-pointer">About</Link></li>
